...
export const NARRATION = [
  ...
  { id: 'dosing',       text: 'Kayden calculates the optimal triazene dose for current conditions and writes that command directly to your pump. No call. No truck. No guesswork.',                                                                       maxDuration: 12000 },
  ...
  { id: 'savings',      text: 'Less triazene wasted. Less labor. No towers out of spec. Kayden pays for itself.',                                                                                                                                        maxDuration: 10000 , speed: 0.90 },
