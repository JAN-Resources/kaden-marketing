...
export const NARRATION = [
  ...
  { id: 'scrubber',     text: 'Your scrubber tower, fully instrumented. Kayden tracks inlet and outlet conditions, plus the level in your fresh scavenger tank - all in real time.',                                                                           maxDuration: 12000 },
  ...
  { id: 'security',     text: 'Your data and your site are fully protected with Kayden. Your field equipment only reaches out to us - nothing can reach back in, so there is no way for anyone to access your PLC from the internet. Your data is encrypted, private, and only visible to your team. And every reading, every command, every change is logged - so you always have the full picture of what happened and when.',  maxDuration: 20000 },
